...
Solo violin vibrato bow sustains (p/f, no round robin) and spiccato (two velocities, two real round robins). Natural sampled bowing, not recorded legato transitions; not a string section.
