(function () {
  ...
  const libraries = {
    practiceAudio: ['practice-audio.js?v=20260908-5', () => window.practiceAudio],
    practice: ['practice.js?v=20260908-5', () => window.practiceStudio],
  ...
  function load(name) {
    if(name==='studio')return load('practiceAudio').then(()=>load('practice'));
