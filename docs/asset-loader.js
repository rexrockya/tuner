(function () {
  ...
  const libraries = {
    arrangement: ['practice-arrangement.js?v=20260909-recordings-1',()=>window.practiceArrangements],
    ...
    samples: ['practice-samples.js?v=20260909-recordings-1', () => window.practiceSamples],
    practiceAudio: ['practice-audio.js?v=20260909-recordings-1', () => window.practiceAudio],
    practice: ['practice.js?v=20260909-recordings-1', () => window.practiceStudio],
  ...
  function load(name) {
    if(name==='studio')return load('arrangement').then(()=>load('genres')).then(()=>load('samples')).then(()=>load('practiceAudio')).then(()=>load('practice')).then(()=>load('curriculum')).then(()=>load('courses'));
