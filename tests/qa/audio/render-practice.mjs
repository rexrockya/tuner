...
const names=['harmony.js','practice-arrangement.js','score-audio.js','practice-audio.js','practice-timbres.js','assets/audio/smplr-1.0.0.mjs','assets/audio/blues/manifest.json'];
...
async function render(name,selection,kind){const isMix=['mix','challenge','stress'].includes(kind),bpm=kind==='stress'?180:96,seconds=60/bpm,songBeats=isMix?16:12,rate=44100,duration=songBeats*seconds+1.25;
 ...
 for(const file of ['harmony.js','practice-arrangement.js','score-audio.js'])vm.runInContext(fs.readFileSync(path.join(snapshot,file),'utf8'),box,{filename:file});
...
const all=[['mix-bright',{lead:'bright'},'mix'],['mix-crunch',{lead:'crunch'},'mix'],['challenge-warm',{lead:'warm',bass:'precision'},'challenge'],['stress-warm',{lead:'warm',bass:'precision',keys:'gospel',rhythm:'warm',drums:'crisp'},'stress'],['stress-bright',{lead:'bright',bass:'precision',keys:'gospel',rhythm:'bright',drums:'crisp'},'stress'],['stress-crunch',{lead:'crunch',bass:'precision',keys:'gospel',rhythm:'crunch',drums:'crisp'},'stress'],['stress-violin',{lead:'violin',bass:'precision',keys:'gospel',rhythm:'warm',drums:'crisp'},'stress'],['lead-warm',{lead:'warm'},'lead'],['lead-bright',{lead:'bright'},'lead'],['lead-crunch',{lead:'crunch'},'lead'],['lead-violin',{lead:'violin'},'lead'],['lead-piano',{lead:'piano'},'lead'],['bass-precision',{bass:'precision'},'bass'],['bass-round',{bass:'round'},'bass'],['bass-bright',{bass:'bright'},'bass'],['bass-muted',{bass:'muted'},'bass'],['rhythm-warm',{rhythm:'warm'},'rhythm'],['rhythm-bright',{rhythm:'bright'},'rhythm'],['rhythm-crunch',{rhythm:'crunch'},'rhythm'],['mix-precision',{lead:'warm',bass:'precision'},'mix'],['mix-warm',{lead:'warm'},'mix'],['mix-violin',{lead:'violin'},'mix'],['mix-piano',{lead:'piano'},'mix']];
